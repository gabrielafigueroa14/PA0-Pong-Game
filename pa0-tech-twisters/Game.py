...
def ball_movement():
    ...
    if ball.colliderect(player):
        if abs(ball.bottom - player.top) < 10:  # Check if ball hits the top of the paddle
            ...
            # TODO Task 5: Increase the ball's speed by x
            # TODO Task 6: Add sound effects
            pygame.mixer.init()
            pygame.mixer.music.load("Song_Mario.wav")
...
red = (255, 0, 0)
black = (0, 0, 0)
bg_color = pygame.image.load('P0_wallpaper.jpg')
bg_color = pygame.transform.scale(bg_color, (screen_width, screen_height))

# Game Rectangles (ball and player paddle)
ball = pygame.Rect(screen_width / 2 - 15, screen_height / 2 - 15, 30, 30)  # Ball (centered)
# TODO Task 1 Make the paddle bigger
player = pygame.Rect(screen_width/2 - 45, screen_height - 20, 200, 15)  # Player paddle
...
# Score Text setup
score = 0
basic_font = pygame.font.Font('freesansbold.ttf', 40)  # Font for displaying score
...
while True:
    ...
    name = "Gabriela Y. Figueroa Castro"
    ...
    # Visuals
    screen.blit(bg_color, (0,0))  # Clear screen with background color
    pygame.draw.rect(screen, black, player)  # Draw player paddle
    # TODO Task 3: Change color of the ball
    pygame.draw.ellipse(screen, black, ball)  # Draw ball
